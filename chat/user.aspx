...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        UserID = SupplierAPI.getMainModelsByChatGuid(Guid.Parse(Request("UserGuid"))).ID
        SupplierID = SupplierAPI.getMainModelsByChatGuid(Guid.Parse(Request("SupplierGuid"))).ID
        Dim checkAccess = New WaitingList(UserID, SupplierID).RunClass()
        ...
        End If
        Try
            inChat.SendNotification(SupplierAPI.getMainModelsByNum(SupplierID), "startCall", Guid.NewGuid(), 0)
...
<body style="margin: 0 0" class="userBody">
	...
	<script src="user.js?v=1.02"></script>
